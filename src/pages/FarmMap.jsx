...
//       <Card>
//   {/* MAP WRAPPER */}
//   <div className="relative w-full h-[600px] overflow-hidden rounded-lg border-2 border-green-400">

//     {/* ✅ FIXED GRID (STATIC BACKGROUND) */}
...
//         <>
//           {/* TOOLBAR */}
//           <div className="absolute top-3 right-3 z-50 flex gap-2 bg-white/90 backdrop-blur rounded-lg p-2 shadow">
...
//     {/* 📍 LEGEND (FIXED) */}
//     <div className="absolute top-4 left-4 z-50 bg-white/95 backdrop-blur-sm rounded-xl shadow p-4 text-sm border">
...
//         <span className="font-bold text-green-700">{plants.length}</span>
//       </div>
...
/* ---------------- PLANT MARKER ---------------- */
const PlantMarker = ({ plant, position, onClick, isSelected, scale }) => {
  const size = scale > 2 ? 14 : scale > 1.5 ? 12 : 10;
...
const PlantDetailModal = ({ plant, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-[200]">
      <div className="bg-white rounded-xl w-[90%] max-w-xl overflow-hidden shadow-2xl">
        ...
        <div className="p-5 space-y-3">
          ...
          <p className="text-sm text-gray-500">
            Uploaded: {new Date(plant.uploadedAt).toLocaleString()}
          </p>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Farm Map</h1>
        <p className="text-gray-600">
          Interactive crop visualization • {plants.length} plants
        </p>
      </div>

      <Card>
        {/* MAP CONTAINER */}
        <div className="relative w-full h-[600px] rounded-lg overflow-hidden border-2 border-green-400">

          {/* ✅ FIXED GRID (STATIC) */}
          <svg className="absolute inset-0 w-full h-full pointer-events-none z-0">
            <defs>
              <pattern id="minor" width="20" height="20" patternUnits="userSpaceOnUse">
                <path d="M20 0L0 0 0 20" fill="none" stroke="rgba(34,197,94,0.15)" />
              </pattern>
              <pattern id="major" width="60" height="60" patternUnits="userSpaceOnUse">
                <path d="M60 0L0 0 0 60" fill="none" stroke="rgba(34,197,94,0.35)" strokeWidth="1.2" />
              </pattern>
            </defs>
          ...
          {/* LEGEND */}
          <div className="absolute top-4 left-4 z-50 bg-white/95 rounded-xl shadow p-4 text-sm">
            <div className="font-bold flex items-center gap-2 mb-2">
              <MapPin size={16} className="text-green-600" />
              Map Legend
            </div>
